---
name: spec
description: Write the design pack for a visual piece - layout, copy deck and image prompts.
---

# Design pack

Use for a carousel, an infographic, or any piece I will build in my own design tool.
...
2. Write `spec.md` with:
   ...
   - **ASCII layouts** with placeholders, never the real text:
     ...
     Add a slot if it would help; I decide whether it stays.
